...
from packages.open_aea.protocols.signing.custom_types import ErrorCode as CustomErrorCode
from packages.open_aea.protocols.signing.custom_types import RawMessage as CustomRawMessage
from packages.open_aea.protocols.signing.custom_types import RawTransaction as CustomRawTransaction
from packages.open_aea.protocols.signing.custom_types import SignedMessage as CustomSignedMessage
from packages.open_aea.protocols.signing.custom_types import SignedTransaction as CustomSignedTransaction
        ...
        try:
            ...
            if self.performative == SigningMessage.Performative.SIGN_TRANSACTION:
                ...
                enforce(
                    ...
                    "Invalid type for content 'terms'. Expected 'Terms'. Found '{}'.".format(type(self.terms)),
                )
                enforce(
